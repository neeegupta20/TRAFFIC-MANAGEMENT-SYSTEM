...
pygame.display.set_caption("AI Traffic Management with Random Forest")
...
class RandomForestTrafficController:
    def __init__(self):
    ...
    def train(self, features, labels):
        if len(features) > 10:
            ...
            print("Random Forest model trained with", len(features), "samples")
...
class TrafficLightSystem:
    def __init__(self):
        ...
        self.rf_controller = RandomForestTrafficController()
    ...
    def update(self, vehicles):
        ...
        if time_since_change > self.green_duration + self.yellow_duration:
            ...
            # Train Random Forest model with collected data
            self.rf_controller.train(self.data_collector.features, self.data_collector.labels)
            ...
            # Get current traffic state for RF prediction
            current_state = {
                'north_count': vehicle_counts[NORTH],
                'east_count': vehicle_counts[EAST],
                'south_count': vehicle_counts[SOUTH],
            ...
            self.green_duration = self.rf_controller.predict_best_duration(current_state)
...
def main():
    ...
    while running:
        ...
        stats = [
            ...
            f"Random Forest Model: {'Trained' if traffic_light_system.rf_controller.is_trained else 'Training...'}",
